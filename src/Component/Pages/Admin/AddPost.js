...
class AddPost extends Component{
    ...
    uploadImage = (e) => {
        ...
        data.append('file',e.target.files[0],new Date().toString() + e.target.files[0].name);
    ...
    render() {
        ...
        return (
            ...
            <Form className={classes.container} ref={form => this.form = form}>
            <Paper className={classes.leftSide}>
              ...
              />
               ...
               <ReactQuill 
                  ...
                  placeholder="Writensome cool stuff"
